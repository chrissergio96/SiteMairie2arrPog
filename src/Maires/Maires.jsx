...
import './Maires.css'; // fichier CSS pour styliser la page
  ...
  return (
    <div className="maire-page">
      ...
      <section className="biography">
        <h1>Maire du 2e Arrondissement de Port-Gentil</h1>
        <img className='inaug' src={InaugurationImage} alt="Acte de naissance" />

        <p>
          Monsieur <strong style={{color:'#1B3D71'}}>Boubakar NGOUWA GUINGO MAYAKI</strong> est le Délégué Spédial du 2e Arrondissement de Port-Gentil depuis 2023.
      ...
      <section className="gallery">
        ...
        <img src={InaugurationImage} alt="Acte de naissance" />
